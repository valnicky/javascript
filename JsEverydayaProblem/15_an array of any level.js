...
here is my solution, first i using toString to convert array to string and then search on ( [ or ] ) and remove it using regular expression split string with ( , ) then filter array to remove any empty string then finally map the result to convert it to number 
