...
console.log(check([1,4,6,8,8,6,1,4])); // true
console.log(check(["a","b","d","g","f","b","g","d","a"]));  // true
console.log(check(["a","b","d","g","f","b","g","f","a"]));// false
console.log(check([10,20,30,40,10,20,50]));  // false

console.log(chec([1,4,6,8,8,6,1,4])); // true
console.log(chec(["a","b","d","g","f","b","g","d","a"]));  // true
console.log(chec(["a","b","d","g","f","b","g","f","a"]));// false
console.log(chec([10,20,30,40,10,20,50]));  // false