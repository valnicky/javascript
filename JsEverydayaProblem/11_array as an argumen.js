...
Outside the for loop, if the trigger is still set to Y, this means all values in the array were divisible by the value in the variable multiple. 
Break out of all the loops at this point.
...
/*function smallestDivisible(array){
  ...
  let arr = array.sort(function (x, y) {return x - y;});
...
console.log(smallestDivisible([1,10,3,9,11]));