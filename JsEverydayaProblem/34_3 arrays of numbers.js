...
true if the first and seconds array has the same elements in the same indexes so they should be the same length and the third array can have a 
bigger length but still have the same elements in the same indexes of the first and second one
...
console.log(checkAr([1,2,3],[1,2,3],[1,2,3])); // true
console.log(checkAr([1,2,3],[1,2,3],[1,2,3,4,5,6])); // true
console.log(checkAr([1,2,3],[1,3,3],[1,2,3,4,5,6])); // false
console.log(checkAr([1,2,3],[1,2,3],[1,2]));  // false