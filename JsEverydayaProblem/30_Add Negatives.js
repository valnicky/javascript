Add Negatives
Write a function that takes an array of elements of any data type and return a number represents sum of (multiplication result of all non negative numbers with 0 included and sum of all negative numbers)
