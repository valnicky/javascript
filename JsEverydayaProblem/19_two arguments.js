...
When looping through the array, if the index of Ith element is multiple of the desired lenght of the chunks, then group the elements in an array of n elements, else return a false value (0).
