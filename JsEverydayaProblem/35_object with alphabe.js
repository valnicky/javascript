...
for loop set to run across the key array length. Within each index, the output object is given the value of the name:value at the input objects value. The name is the incremented index value stored in the array key.
output variable returned from function.
